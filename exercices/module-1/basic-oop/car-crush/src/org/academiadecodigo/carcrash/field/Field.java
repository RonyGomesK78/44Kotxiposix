    ...
    public static void draw(Car[] cars) {
        ...
        for (Car c : cars) {
            ...
            if (!c.isCrashed()) {
                ...
                if(c instanceof Mustang){

                    screenWriter.setBackgroundColor(Terminal.Color.YELLOW);
                ...
                screen.putString(c.getPos().getCol(), c.getPos().getRow(), "C", Terminal.Color.WHITE, Terminal.Color.RED, ScreenCharacterStyle.Blinking);
            }
